...
<script>
	...
	function id_check(){
		...
		var url =  "id_check.jsp?userid=" + userid.value;
		window.open(url,"id_duplicate_check","toolbar = no width = 350 height = 250 status = no");
	}
...
<tr>
  ...
  <td width="80%" valign="top">&nbsp;<img src="./img/title1.gif" ><br>    
	<form name=info_form method=post action = userinfo_list.jsp>
			...
			<table cellpadding=0 cellspacing=0 border=0 width=650 align=center>       
				<tr>
                 ...
                 6~12자 이내의 영문이나 숫자만 가능합니다.
							...
							<tr>
								<TD BGCOLOR="#EFF4F8">&nbsp;주소지 이름<font color=red>&nbsp;</font></td>
								<TD BGCOLOR=WHITE>
            ...
            <table cellpadding=0 cellspacing=0 border=0 width=100%>
              ...
              <tr bgcolor=#ffffff>
                <td colspan=3 align=center>
                  <a href = "#" onClick = form_check()><img src="./img/u_bt06.gif" vspace=3 border=0 name=img3></a>
