...
<%
	...
	try {
		...
		while (rs.next()) {
			...
			bvo.setContents(linebreak(rs.getString(7)));
...
<html>
 ...
 <script>
	function deletefunc(num){
		...
		window.open("board_delete.jsp?num=" + num,"delete","width=300,height=200");
	}
   ...
   <table border="0" width="800">
     <tr>
      ...
      <font size="2">
	   ...
	   <!-- 답글쓰기 -->
       <a href="board_reply.jsp">
       <img src="./img/reply.gif" border="0"></a>&nbsp;&nbsp;
	   <!-- 수정하기 -->
       <a href="board_modify.jsp?num=${bvo.num }">
       <img src="./img/edit.gif" border="0"></a>&nbsp;&nbsp;
         <!-- 삭제하기 -->
       <a href="#" onClick = "deletefunc(${bvo.num})"><img src="./img/del.gif" border="0"></a>&nbsp;&nbsp;
       <!-- 목록보기 -->
