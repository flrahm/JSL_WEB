...
<%
	...
	int flag = 0;	// -1 이면 처음, 0이면 중복, 1이면 사용가능
	if(userid == null)
		flag = -1;
	
	if(flag != -1){
		MemberManager manager = MemberManager.getInstance();
		boolean isOverlap =  manager.userIdDuplication(userid);
		if(!isOverlap)
			flag = 1;
...
<TABLE CELLPADDING=0 CELLSPACING=0 BORDER=0 WIDTH=330>
  ...
  <tr>
    <td colspan=3 align=center>
      <A href = "#" onclick = "javascript:cancle();"><img src="./img/u_bt13.gif" border=0 vspace=5></A>
    </td>
  </tr>
</table>
</BODY>
