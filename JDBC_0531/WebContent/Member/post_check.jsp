...
<%@page import="zipSample.dao.ZipSampleDAO"%>
<%@page import="zipSample.vo.ZipSampleVO"%>
...
<%
	...
	List<ZipSampleVO> zList = new ArrayList<ZipSampleVO>(); 
	
	if(addr1 != null && !addr1.equals("")){
		ZipSampleDAO zdao = new ZipSampleDAO();
		zList = zdao.selectByAddr1(addr1);
	}
...
<TABLE CELLPADDING=0 CELLSPACING=0 BORDER=0 WIDTH=330><TR><TD BGCOLOR=#948DCF>
  <TABLE CELLPADDING=0 CELLSPACING=1 BORDER=0 WIDTH=330><TR><TD>
    ...
    <FORM NAME="inquiry" METHOD="get" ACTION="post_check.jsp">
      <TR>
        <TD ALIGN=CENTER><br>
          동이름 입력 : <INPUT NAME="addr" TYPE="text" style="width:120">
         <a href = "#" onClick = "javascript:check()"> <INPUT TYPE="image" src="./img/u_bt08.gif" hspace=10></a>
        </TD>
      </TR>
      <TR>
        <TD ALIGN=CENTER>
...
<TABLE CELLPADDING=0 CELLSPACING=0 BORDER=0 WIDTH=330>
  ...
  <tr>
    <td colspan=2 align=center>
      <A href = "#" onClick = "self.close()"><img src="./img/u_bt13.gif" border=0 vspace=5></A>    </td>
  </tr>
</table>
</BODY>
</HTML>
