     ...
     <form method="post" >
      ...
      <table border="0">
       <tr>
         ...
         <td width="80%">
         <input type="text" size="20" name="writer" value="${board.writer }" readonly></td>
       </tr>
       <tr>
         <td align="right">&nbsp;</td>
       ...
       <tr>
         ...
         <td>
          <input type="radio" size="20" name="isOpen" value = "1" <c:if test="${board.isOpen == 1 }">checked</c:if> >공개 
          <input type="radio" size="20" name="isOpen" value = "0" <c:if test="${board.isOpen == 0 }">checked</c:if>  >비공개
       ...
       <tr>
         ...
         <td><font size="2" face="돋움">비밀번호</font></td>
          <td><input type="password" size="10" name="passwd" value = "${board.passwd }" >
