...
<script type="text/javascript">
	function send(){
		...
		board.action = "board_write_pro.jsp";
		board.submit();
	}
     ...
     <form method="post" name = "board" >
	  ...
	  <table border="0">
       <tr>
         ...
         <td width="80%">
         <input type="text" size="20" name="writer"></td>
       </tr>
       <tr>
         <td align="right">&nbsp;</td>
       ...
       <tr>
         <td align="right">&nbsp;</td>
         <td ><font size="2 face="돋움"">공개여부</font></td>
         <td>
          <input type="radio" size="20" name="isOpen" value = 1 selected>공개 
          <input type="radio" size="20" name="isOpen" value = "0">비공개
          </td>
       </tr>
	   ...
	   <tr>
         ...
         <td><font size="2" face="돋움">비밀번호</font></td>
          <td><input type="password" size="10" name="passwd" ><font size="2" face="돋움">*.수정과 삭제시 꼭 입력하셔야 합니다.</font></td>
        </tr>
        <tr></tr>
		<tr>
          <td align="right">&nbsp;</td>
          ...
          <td>
                     <a href="#" onClick = "send()"><img src="./img/save.gif" border=0></a>&nbsp;&nbsp;&nbsp;
