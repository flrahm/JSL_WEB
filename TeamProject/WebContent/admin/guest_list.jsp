	...
	<tr>
		<td align="center" height="100%" valign=middle><br>
								<table width="30%" border="1" cellspacing="0" cellpadding="3" bgcolor="#FFCC66" bordercolor="#FFFFFF" bordercolorlight="#000000">
									<tr> 
										<td height=40 align="center" style="font-size: 15px;"><b>방명록 리스트</b></a>
										</b></td>
									</tr>
								</table><br>
                  ...
                  <tr>
                    <td><table width="100%" border="0" cellpadding="6" cellspacing="1" bgcolor="DDDDDD">
                      ...
                      <tr>
                        <td align="center" bgcolor="#FFFFFF">${guest.idx }</td>
                        <td bgcolor="#FFFFFF"><a href="adminguestview.do?idx=${guest.idx }" class="unnamed1">${guest.subject }</a></td>
                        <td align="center" bgcolor="#FFFFFF">${guest.name }</td>
                        <td align="center" bgcolor="#FFFFFF">${guest.indate }</td>
						<td align="center" bgcolor="#FFFFFF">${guest.readcnt }</td>
                      </tr>
                      </c:forEach>
                      </c:if>
                      <c:if test="${list.size()==0 }">
                      <tr>
                        <td colspan="5" align="center" bgcolor="#FFFFFF">등록된 자료가 없습니다.</td>
                      </tr>
                      </c:if>
	                     <tr>
                        <td height="35" colspan="10" align="center" bgcolor="#FFFFFF">[1][2][3]</td>
                      </tr>
											<form name = "noticelist" method = "post" action = "adminguestsearch.do">
                      <tr>
                        <td colspan="10" align="center" bgcolor="#FFFFFF"><table width="610" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              ...
                              <td width=20% align="right"><a href = "#" onClick = "onSubmit()"><b>[검색]</b></a>  &nbsp;<a href = "adminguestwrite.do"><b>[글쓰기]</b></a></td>
                            </tr>
									</form>
                        </table></td>
                      </tr>
