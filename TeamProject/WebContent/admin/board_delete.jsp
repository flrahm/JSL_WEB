	...
	<tr>
		<td align="center" height="100%" valign=middle><br>
			<table width="30%" border="1" cellspacing="0" cellpadding="3" bgcolor="#FFCC66" bordercolor="#FFFFFF" bordercolorlight="#000000">
				<tr> 
					<td height=40 align="center" style="font-size: 15px;"><b>협력업체[등록][삭제]</b></a>
					</b></td>
				</tr>
			</table><br>
			...
			<table width="60%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td align=center><b><a href = "adminboardreply.do"> [답변] </a><a href = "adminboardmodify.do"> [등록] </a></b>&nbsp; <a href = "adminboardlist.do"><b>[취소]</b></a></td>
				</tr>
			</table>
</body>
</html>
