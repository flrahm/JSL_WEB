...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td align="center" height="100%" valign=middle><br>
			...
			<table width="60%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td align=center><a href = "adminboardreply.do"><b>[답변]</b></a>&nbsp; <a href = "adminboardmodify.do?num=${vo.num }"><b>[수정]</b></a>&nbsp; <a href = "adminboarddelete.do?num=${vo.num }"><b>[삭제]</b></a>&nbsp; <a href = "adminboardlist.do"><b>[취소]</b></a></td>
				</tr>
			</table>
</body>
</html>
