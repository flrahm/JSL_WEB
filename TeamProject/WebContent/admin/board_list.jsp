		...
		<td align="center" height="100%" valign=middle><br>
                  ...
                  <tr>
                    <td><table width="100%" border="0" cellpadding="6" cellspacing="1" bgcolor="DDDDDD">
                      ...
                      <tr>
                        <td align="center" bgcolor="#FFFFFF">${board.num }</td>
                        <td bgcolor="#FFFFFF"><a href = "adminboardview.do?num=${board.num }">${board.subject }</a></td>
                        <td align="center" bgcolor="#FFFFFF">${board.name }</td>
												<td align="center" bgcolor="#FFFFFF">${board.indate }</td>
                      ...
                      <c:if test="${list.size()==0 }">
                      	<tr>
                        	<td align="center" bgcolor="#FFFFFF" colspan="5">등록된 게시판이 없습니다.</td>
                      	</tr>
                      </c:if>
	                     <tr>
                        <td height="35" colspan="10" align="center" bgcolor="#FFFFFF"></td>
                      </tr>
					<form name = "boardlist" method = "post" action = "adminboardsearch.do">
                      <tr>
                        <td colspan="10" align="center" bgcolor="#FFFFFF"><table width="610" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              ...
                              <td width=20% align="right"><b><a href = "#" onClick = "onSubmit()">[검색]</a></b>  &nbsp;<a href = "adminboardwrite.do"><b>[글쓰기]</b></a></td>
                            </tr>
                     </form>       
                        </table></td>
                      </tr>
