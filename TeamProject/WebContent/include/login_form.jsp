...
<script>
	function onLogin(){
		loginform.action.value = "loginform.do";
		loginform.submit();
	}
...
<jsp:include page = "/include/topmenu.jsp"></jsp:include>
 ...
 <body>
   ...
   <form name = "loginform" method = "post">
     ...
     <tr>
       <td><input type = "image" src = "include/img/login1.gif" border = "0" onClick = "onLogin()"></td>
			 <td>
           <a href = "userinfoinsert.do"><img src="include/img/regist.gif" border="0"></a>
       </td>
     </tr>
 </form>
 </table>
