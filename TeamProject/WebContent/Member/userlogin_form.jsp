...
${row }
<c:if test ="${row2 != null }">
<c:set var ="row" value ="${row2 }"></c:set>
</c:if>
<HTML>
<HEAD>
<TITLE>로그온</TITLE>
...
<script>
	...
	function onSubmit(){
		if(userloginform.userid.value == "") {
			alert("아이디를 입력해주세요");
			userloginform.userid.focus();
			return;
		}
		
		if(userloginform.passwd.value == "") {
			alert("비밀번호를 입력해주세요");
			userloginform.passwd.focus();
			return; 
		}
...
<br><br>
<form name = "userloginform" method = "post" action = "userloginform.do">
	    ...
	    <tr>
		  <td height="298"> 
		    <table width="100%" border="0" cellspacing="0" cellpadding="0">
			  <tr> 
			    <td width="9"><img src="Member/img/h_b02.gif" width="9" height="21"></td>
				<td bgcolor="7aaad5"> 
				 <div align="center"><font color="#FFFFFF"><b>Member Login</b></font></div>
				 </td>
				 <td width="9"><img src="Member/img/f_b03.gif" width="9" height="21"></td>
			  </tr>
			 </table>
			 ...
			 <table border="0" cellpadding="0" cellspacing="0" width="550">
				     ...
				     <tr bgcolor="#FFFFFF"> 
					   <td align=CENTER bgcolor="#eff4f8" height="92"> 
					     <table width="330" border="0" cellspacing="0" cellpadding="1">
							<tr valign=bottom> 
							  <td width="21"><img src="Member/img/h_bl02.gif" width="18" height="16"></td>
							...
							<tr valign=bottom> 
							  <td><img src="Member/img/h_bl02.gif" width="18" height="16"></td>
							  <td nowrap>비밀번호</td>
							  <td>: 
								<input type=password name="passwd" size=14 maxlength=12 STYLE="WIDTH:155">
							  </td>
					</form>
							  <td><a href = "#" onClick = "onSubmit();"><img src="Member/img/login.gif" border=0 align=absmiddle></a></td>
							</tr>
						  </table>
			  ...
			  <table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr> 
				  <td width="9"><img src="Member/img/h_b04.gif" width="12" height="11"></td>
				  <td bgcolor="7aaad5" width="612"> 
					<div align="center"></div>
				  </td>
				  <td width="10"><img src="Member/img/h_b05.gif" width="12" height="11"></td>
				</tr>
			  </table>
			</td>
  		</tr>
