  ...
  <tr>
    ...
    <table border="0" cellspacing="1" width="100%" align="center">
      ...
      <tr>
		...
		<font size="2" face="고딕">전체 : <b>${list.size() }</b>건 - 1/ 2 Pages</font></td></tr>
 	   <tr bgcolor="e3e9ff">
 	 ...
 	 <c:if test ="${list.size() == 1 }"> 
        ...
        <font face="돋움" size="2" color="#000000">${list.num}</font></td>
			<td align="left" height="20">&nbsp;
				<font face="돋움" size="2" color="#000000">
				<a class="list" href="boardview.do?num=${list.num}">${list.subject }</a></td>
	...
	<c:forEach var="board" items="${list }">
			...
			<tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
        <td align="center" height="25">
        <font face="돋움" size="2" color="#000000">${count}</font></td>
			<td align="left" height="20">&nbsp;
				<font face="돋움" size="2" color="#000000">
				<a class="list" href="boardview.do?num=${board.num}">${board.subject }</a></td>
					<td align="center" height="20"><font face="돋움" size="2">
					<a class="list" href="mailto:ein1027@nate.com">${board.name }</a></font></td>
				<td align="center" height="20"><font face="돋움" size="2">${board.indate.substring(0,11) }</font></td>
				<td align="center" height="20"><font face="돋움" size="2">
...
<form method="post" action="boardlist.do" name="boardsearch">	
	<table width="600">
		<tr>
			<td width="25%"> &nbsp;</td>
				...
				<table>
					...
					<!-- 검색어를 이용하여 글제목, 작성자, 글내용 중에 하나를 입력 받아 처리하기 위한 부분 -->
						<tr>
							...
							<td> <input type="text" size=20 name="input"></td>
							<td> <a href="#" onClick="javascript:a()"><img src="Board/img/search2.gif" border="0"></a></td>
						</tr>
				
				</table>
			</td>
			<td width="25%" align="right">
			<a href="boardwrite.do"><img src="Board/img/write.gif" border="0"></a>
			</td>
		</tr>
