   ...
   <table border="0" width="800">
     <tr>
         ...
         <tr>
           <td class="content">
             <p align="right"><font size="2" face="돋움">
              <a class="list" href="mailto:ein1027@nate.com"> ${vo.name }</a> / <font size="2" face="돋움">${vo.indate.substring(0,11) } / ${vo.readcnt}번 읽음</font>
             <p>
      ...
      <font size="2">
	   ...
	   <!-- 답글쓰기 -->
       <a href = "boardreply.do">
       <img src="Board/img/reply.gif" border="0"></a>&nbsp;&nbsp;
	   <!-- 수정하기 -->
       <a href = "boardmodify.do?num=${vo.num}">
       <img src="Board/img/edit.gif" border="0"></a>&nbsp;&nbsp;
         <!-- 삭제하기 -->
       <a href = "#" onClick = "javascript:window.open('boarddelete.do?num=${vo.num}','delete','width=300,height=200')"><img src="Board/img/del.gif" border="0"></a>&nbsp;&nbsp;
       <!-- 목록보기 -->
       <a href = "boardlist.do"><img src="Board/img/list-2.gif" border="0"></a>&nbsp;&nbsp;
      </font>
    </td>
  </tr>
  </table>
