...
<script>
	function onSubmit(){
		boardreply.action.value = "boardreply.do";
		boardreply.submit();
	}
</script>
	  ...
	  <table border="0">
	   ...
	   <tr>
		...
		<tr>
          ...
          <td>
                     <a href="#" onClick = "onSubmit()"><img src="Board/img/save.gif" border=0></a>&nbsp;&nbsp;&nbsp;
                     <a href="boardview.do"><img src="Board/img/cancle.gif" border=0></a>
          </td>
        </tr>
      </table>
      </form>
