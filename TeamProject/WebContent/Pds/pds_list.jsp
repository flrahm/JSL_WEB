...
<!--  다음에 추가할 부분 -->
    ...
    <table border="0" cellspacing="1" width="100%" align="center">
      ...
      <tr>
        <td colspan="7" align="right" valign="middle" height="20">
		  <font size="2" face="고딕">전체 : <b>${list.size() }</b>건 </font>
		</td>
	  </tr>
	  <tr bgcolor="e3e9ff">
  ...
  <tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
        ...
        <font face="돋움" size="2" color="#000000">${pds.num}</font></td>
				<td align="left" height="20">&nbsp;<font face="돋움" size="2"><a href = "pdsview.do?num=${pds.num } ">${pds.subject }</a></font></td>
        <td align="center" height="20"><font face="돋움" size="2">${pds.filename}</td>
				...
				<td align="left" height="20"><font face="돋움" size="2">${pds.indate}</font></td>
...
<c:forEach var="pds" items="${list }">
   ...
   <tr>
      <td colspan="7" align="right">
				<a href = "pdswrite.do"><img src="Pds/img/write.gif" alt="자료등록" align="middle" border="0"></a>
      &nbsp;
	  </td>
   </tr>

     <table border="0" cellspacing="0" width="100%">
     <form name = "pdslist" method = "post" action = "pdssearch.do">
      <tr>
      <td><center>
      <font color="#004080" size="4" face="Courier New"><strong>Search&nbsp;</strong></font>
		...
		&nbsp;&nbsp;<a href = "#" onClick = "onSubmit()"><input type="image" src="Pds/img/search2.gif" align="middle"></a>
	   </td>
	   </tr>
	   </form>
    </table>
