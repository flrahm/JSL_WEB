...
<script>
	function writeFrm_check(){
		...
		if(writeFrm.subject.value == ""){
			alert("제목은 필수 입력입니다");
			writeFrm.subject.focus();
			return false;
		}
		
		if(writeFrm.contents.value == ""){
			alert("내용은 필수 입력입니다");
			writeFrm.contents.focus();
			return false;
		}
		
		if(writeFrm.pass.value == ""){
 ...
 <tr>
   ...
   <td width="80%" valign="top">&nbsp;<br>
     <img src="/Day_0611/Board/img/bullet-01.gif"><font size="3" face="돋움" color="blue"> <b>반갑습니다</b></font>
     ...
     <form method="post" name = "writeFrm" action = "/Day_0611/board_write.do">
	  ...
	  <table border="0">
	   ...
	   <tr>
		...
		<tr>
          ...
          <td>
                     <a href="#" onclick = "writeFrm_check()"><img src="/Day_0611/Board/img/save.gif" border=0></a>&nbsp;&nbsp;&nbsp;
                     <a href="#" onclick = "document.writeFrm.reset()"><img src="/Day_0611/Board/img/cancle.gif" border=0></a>
          </td>
        </tr>
      </table>
      </form>
