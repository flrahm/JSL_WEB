...
<script>
	...
	function id_check(){
		...
		// 2.아이디 중복 검사(id_check.jsp)
		var temp_url = "id_check.jsp?userid=" + id.value;
		window.open(temp_url,"id_duplicate_check","toolbar = no width = 350 height = 250 status = no");
...
<tr>
  ...
  <td width="80%" valign="top">&nbsp;<img src="./img/title1.gif" ><br>    
	<form name=frm method=post action = userInfo_insert_ok.jsp>
