...
<%
	...
	String idx = getInitParameter("idx");	// 게시글 번호
	// 쿠키가 생성되어 있는지름 검사
	...
	for(int i = 0; i < cookies.length ; i++){
		if(cookies[i].getName().equals("guestCookie" + idx)){
			isCookie = true;
			break;
		}
	}
	...
	if(!isCookie){
		readCnt ++;// 조회수 증가
		infoCookie = new Cookie("guestCookie"+idx,newValue);
         ...
         <tr>
           <td class="content">
             <p align="right"><font size="2" face="돋움">
              나종민  / <font size="2" face="돋움">2007-10-22 / <%=readCnt %> 번 읽음</font>
             <p>
             내용이 들어가는 부분<p>
           </td>
         </tr>
