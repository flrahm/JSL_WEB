  ...
  <tr>
    ...
    <table border="0" cellspacing="1" width="100%" align="center">
      ...
      <tr>
		...
		<font size="2" face="고딕">전체 : <b>${bList.size() }</b>건 - 1/ 2 Pages</font></td></tr>
 	   <tr bgcolor="e3e9ff">
        ...
        <font face="돋움" size="2" color="#000000">${vo.num }</font></td>
			<td align="left" height="20">&nbsp;
				<font face="돋움" size="2" color="#000000">
				<a class="list" href="board_view.jsp?num=${vo.num }">${vo.subject }</a></td>
					<td align="center" height="20"><font face="돋움" size="2">
					<a class="list" href="mailto:${vo.email }">${vo.name }</a></font></td>
				<td align="center" height="20"><font face="돋움" size="2">${vo.email }</font></td>
				<td align="center" height="20"><font face="돋움" size="2">
				${vo.readcnt }</font></td>
			</tr>
			</c:forEach>
