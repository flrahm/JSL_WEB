 ...
 <tr>
   ...
   <td width="80%" valign="top">&nbsp;<br>
     ...
     <img src="./img/bullet-02.gif"><font size="2" face="돋움">는 필수 입력 사항입니다.</font><p>
		 ...
		 <form method="post" action="guest_modify_pro.jsp" name="modify">
      ...
      <table border="0">
       <tr>
         ...
         <td width="80%">
         <input type="text" size="20" name="name" value="${gvo.name }" readonly></td>
       </tr>
       <tr>
         <td align="right"><img src="./img/bullet-02.gif"></td>
         <td><font size="2" face="돋움">제목</font></td>
         <td><input type="text" size="60" name="subject" value="${gvo.subject }"></td>
       </tr>
       <tr>
         <td align="right"><img src="./img/bullet-02.gif"></td>
         <td><font size="2" face="돋움">내용</font></td>
         <td><textarea wrap="physical" rows="10" name="contents" cols="60" >${gvo.contents }</textarea></td>
       </tr>
        <tr>
          <td align="right">&nbsp;</td>
